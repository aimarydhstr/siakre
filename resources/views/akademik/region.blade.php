...
<div class="d-flex " id="wrapper" >
    ...
    {{ Breadcrumbs::render('akademik-region') }}
      <!-- navbar -->
      ...
      <div class="content site-content">
        ...
        <div class="d-md-flex align-items-center justify-content-between  mt-4 mb-3">
          ...
          <a href="{{route('export-akademik-region')}}" class="btn btn-outline-primary my-3 my-md-0"><i class="fas fa-download mr-1"></i> Unduh Excel</a>
        </div>
