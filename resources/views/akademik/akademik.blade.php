              ...
              <table class="table table-striped table-range text-center">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$year}}</td>
                    <td> <a href="{{route('akademik-region',['year'=>$year])}}"> {{$region_array[$loop->iteration-1]}}</a></td>
                    <td><a href="{{route('akademik-national',['year'=>$year])}}">{{$national_array[$loop->iteration-1]}}</a></td>
                    <td><a href="{{route('akademik-international',['year'=>$year])}}">{{$international_array[$loop->iteration-1]}}</a></td>
