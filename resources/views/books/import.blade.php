@extends('layout.base')
@section('title','Import Buku (Excel)')
  ...
  <div id="page-content-wrapper" class="site">
    ...
    <div class="content">
      <div class="d-flex align-items-center mb-3 mt-md-4">
        <h4 class="font-weight-bold mb-0">Import Buku (Excel)</h4>
      </div>
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="border rounded p-2 small bg-light">
                  ...
                  <code>isbn, title, publisher, publish_month, publish_year, city, department</code>
                  <div class="mt-2">Header <strong>opsional</strong>:</div>
                  <code>lecturers_nidn, students_nim</code>
                  <ul class="mb-0 mt-2 pl-3">
                    <li><em>publish_month</em>: 1–12.</li>
                    <li><em>publish_year</em>: 1900–2100.</li>
                    <li><em>lecturers_nidn</em> &amp; <em>students_nim</em> bisa banyak (pisahkan koma/semicolon).</li>
                    <li>File PDF buku <em>tidak</em> diimport dari Excel (kolom <code>file</code> diset null).</li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                <table class="table table-sm table-bordered mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>Fundamental Kecerdasan Buatan</td>
                      <td>Penerbit Nusantara</td>
                      <td>10</td>
                      <td>2025</td>
                      <td>Jakarta</td>
