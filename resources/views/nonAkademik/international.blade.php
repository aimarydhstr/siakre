...
<div class="d-flex " id="wrapper" >
    ...
    {{ Breadcrumbs::render('non-akademik-international') }}
      <!-- navbar -->
      ...
      <div class="content site-content">
        ...
        <div class="d-md-flex align-items-center justify-content-between  mt-4 mb-3">
          <h4 class="font-weight-bold mb-0">
            Prestasi Interasional
          </h4>
          <a href="{{route('export-nonAkademik-international')}}" class="btn btn-outline-primary my-3 my-md-0"><i class="fas fa-download mr-1"></i> Unduh Excel</a>
        </div>
