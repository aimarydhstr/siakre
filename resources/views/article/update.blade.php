...
<div class="d-flex" id="wrapper">
  ...
  <div id="page-content-wrapper" class="site">
    ...
    <div class="content">
      ...
      <h4 class="font-weight-bold my-3 mt-md-4">Edit Artikel</h4>

      <form action="{{ route('update_article', ['id' => $article->id]) }}" method="post" enctype="multipart/form-data" class="add">
        @csrf
        @method('PUT')
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group input-group-sm">
                  ...
                  @php $tj = old('type_journal', $article->type_journal); @endphp
                ...
                @if(Auth::user()->role === 'admin' && isset($departments))
                  <div class="form-group input-group-sm">
                    ...
                    <select id="department_id" name="department_id" class="form-control custom-select @error('department_id') is-invalid @enderror" required>
                      <option value="" disabled {{ old('department_id', $article->department_id) ? '' : 'selected' }}>Pilih Program Studi</option>
                      @foreach($departments as $dept)
                        <option value="{{ $dept->id }}" {{ (string)old('department_id', $article->department_id)===(string)$dept->id ? 'selected':'' }}>
                          {{ $dept->name }}
                        </option>
                      @endforeach
                    </select>
              ...
              <div class="col-md-6">
                      ...
                      <div class="bootstrap-iso">
                        <div class="input-group date">
                          ...
                          <input placeholder="dd-mm-yyyy"
                                 ...
                                 id="date" name="date" value="{{ old('date', $dateValue) }}">
                        </div>
                      </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group input-group-sm">
                      ...
                      <input type="text" class="form-control @error('volume') is-invalid @enderror"
                             id="volume" name="volume" value="{{ old('volume', $article->volume) }}" placeholder="Vol">
                  ...
                  <div class="col-md-3">
                    <div class="form-group input-group-sm">
                      ...
                      <input type="text" class="form-control @error('number') is-invalid @enderror"
                             id="number" name="number" value="{{ old('number', $article->number) }}" placeholder="No">
                ...
                <div class="form-group input-group-sm">
                  ...
                  <small class="text-secondary d-block"><i>Kosongkan jika tidak ingin mengganti</i></small>
